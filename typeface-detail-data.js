...
const typefaceDetailConfig = {
    'alvica': {
        ...
        samples: [
        {
            weight: 600,
            fontSize: 120,
            text: 'Sphinx of black judge my vow.',
            sampleId: 'semibold'
        },
        {
            weight: 400,
            fontSize: 100,
            text: 'AaBbCcDdEeFfGg HhliJjKkLlMmNnOo PpQqRrSsTtUuVv WwXxYyZz',
            sampleId: 'regular'
        },
        {
            weight: 700,
        ...
        },
        {
            weight: 700,
            fontSize: 80,
            text: 'Das Wort Schwung bezieht sich im Sinne von eine schnelle, bogenförmige Bewegung auf eine dynamische, kraftvolle Aktivität oder eine elegante Geste, die sowohl körperliche als auch metaphorische Bedeutung haben kann.',
            sampleId: 'bold-de'
        },
        {
            weight: 400,
        ...
        pricing: [
        {
            name: 'INDG Alvica Family',
            price: '102€'
        },
        {
            name: 'INDG Alvica Thin',
            price: '17€'
        },
        {
            name: 'INDG Alvica Light',
            price: '17€'
        },
        {
            name: 'INDG Alvica Regular',
            price: '17€'
        },
        {
            name: 'INDG Alvica Semibold',
            price: '17€'
        },
        {
            name: 'INDG Alvica Bold',
            price: '17€'
        },
        {
            name: 'INDG Alvica Black',
            price: '17€'
        }
    ],
        hasOpenType: true,
    ...
    'actio': {
        ...
        samples: [
        {
            ...
            stretch: 'normal',
            fontSize: 120,
            text: 'Actio displays versatility through its expanded and normal variants.',
            sampleId: 'regular'
        },
        {
            weight: 700,
        ...
        pricing: [
        {
            name: 'INDG Actio Family',
            price: '150€'
        },
        {
            name: 'INDG Actio Thin',
            price: '20€'
        },
        {
            name: 'INDG Actio Thin Expanded',
            price: '20€'
        },
        {
            name: 'INDG Actio Light',
            price: '20€'
        },
        {
            name: 'INDG Actio Light Expanded',
            price: '20€'
        },
        {
            name: 'INDG Actio Regular',
            price: '20€'
        },
        {
            name: 'INDG Actio Regular Expanded',
            price: '20€'
        },
        {
            name: 'INDG Actio Bold',
            price: '20€'
        },
        {
            name: 'INDG Actio Bold Expanded',
            price: '20€'
        },
        {
            name: 'INDG Actio Black',
            price: '20€'
        },
        {
            name: 'INDG Actio Black Expanded',
            price: '20€'
        }
    ],
        hasOpenType: false
    ...
    'modus': {
        ...
        pricing: [
        {
            name: 'INDG Modus Family',
            price: '60€'
        },
        {
            name: 'INDG Modus Grey',
            price: '20€'
        },
        {
            name: 'INDG Modus Black',
            price: '20€'
        },
        {
            name: 'INDG Modus White',
            price: '20€'
        }
    ],
        hasOpenType: false
    ...
    'dale': {
        ...
        pricing: [
        {
            name: 'INDG Dale Family',
            price: '60€'
        },
        {
            name: 'INDG Dale Regular',
            price: '20€'
        },
        {
            name: 'INDG Dale Italic',
            price: '20€'
        },
        {
            name: 'INDG Dale Oblique',
            price: '20€'
        }
    ],
        hasOpenType: false
    ...
    'peqat': {
        ...
        pricing: [
        {
            name: 'INDG Peqat Family',
            price: '45€'
        },
        {
            name: 'INDG Peqat Norma',
            price: '25€'
        },
        {
            name: 'INDG Peqat Capitalis',
            price: '25€'
        }
    ],
        hasOpenType: false
...
if (typeof module !== 'undefined' && module.exports) module.exports = { typefaceDetailConfig };
